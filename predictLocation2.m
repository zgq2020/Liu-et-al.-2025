...
for i = 1:length(tracks)
    ...
    if tracks(i).age==1
        tracks(i).predictedCentroid = tracks(i).data; % If the trajectory appears for the first time, the current position information is used as the predicted centroid.
